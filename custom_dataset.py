...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_custom_infos':
        ...
        create_custom_infos(
            ...
            data_path=ROOT_DIR /dataset_cfg['DATA_PATH'].split('/')[1] / dataset_cfg['DATA_PATH'].split('/')[2],
            save_path=ROOT_DIR /dataset_cfg['DATA_PATH'].split('/')[1] / dataset_cfg['DATA_PATH'].split('/')[2],
        )
